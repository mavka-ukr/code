        ...
        patterns: [
          {
            ...
            match:
              "\\b(дія|клас|спробувати|зловити|модуль|є|або|і|пусто|стрибнути|вабо|не|так|ні|стала|якщо|поки|взяти визначення|взяти біб|взяти|як|вернути|інакше|зовнішня|внутрішня|простір|синонім|змінна|ціль)\\b",
          },
        ],
      },
      strings: {
